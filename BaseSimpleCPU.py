...
for i in range (len(l2_data)):
    ...
    for x in range (len(block_values)):
        ...
        l2_data_aso = []
        for l in range(acc_l2_data_limit + 1):
            l2_data_aso.append(2 ** l)
        l2_data_aso.append(index_a2)
        print(l2_data_aso)
        for y in range(len(l2_data_aso) - 3):
                        ...
                        for w in range (len(block_values)):
                            ...
                            for m in range(len(l1_data_aso)-3):
                                ...
                                for n in range(len(l1_data_aso)-3):
                                    ...
                                    l1_inst_block_str = str(2**block_values[k])
                                    l1_data_block_str = str(2**block_values[w])
                                    ...
                                    block_values_k = str(block_values[k])
                                    f = open(stat_path, "a")
                                    f.write("iteration no ," + str(value) + "," +" l2_data_size," + l2_data_str + "," + "l2_associativity ," + l2_data_aso_str + "," +  "l2_block_size ," + l2_data_block_str + "," + "l1_data_size,"+ l1_data_str + ","+ "l1_inst_size," + l1_inst_str + "," + "l1_inst_block_size," + l1_inst_block_str + "," + "l1_data_block_size," + l1_data_block_str + "," + "l1_data_asociativity," + l1_data_aso_str +","+ " l1_ist_aso_str," + l1_ist_aso_str + "\n" )  # writing back into the file
                                    f.close()
